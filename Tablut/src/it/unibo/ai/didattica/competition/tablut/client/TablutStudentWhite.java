 ...
 * TablutStudentWhite
 */
public class TablutStudentWhite extends TablutClient {

    private final int timeout;

    public TablutStudentWhite(String player, String name, int timeout, String ipAddress) throws UnknownHostException, IOException {
    ...
    public static void main(String[] args) throws UnknownHostException, ClassNotFoundException, IOException {
        ...
        if (args.length < 3) {
            System.out.println("Usage: java TablutStudentWhite <WHITE|BLACK> <timeout> <serverIP>");
            System.exit(-1);
        }
        ...
        TablutStudentWhite client = new TablutStudentWhite(role, teamName, timeout, ipAddress);
        client.run();
    }
