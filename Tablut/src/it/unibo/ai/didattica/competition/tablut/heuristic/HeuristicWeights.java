...
public final class HeuristicWeights {
    ...
    public static final float MATERIAL_WEIGHT = 2.0f; // Peso per l'euristica del materiale
    public static final float MOBILITY_WEIGHT = 1.5f; // Peso per l'euristica della mobilità
